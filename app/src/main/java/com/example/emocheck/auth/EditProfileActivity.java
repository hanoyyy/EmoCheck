...
public class EditProfileActivity extends AppCompatActivity {
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNameChanged() || isEmailChanged() || isPasswordChanged()) {
                    ...
                    intent.putExtra("name", nameUser); // Kirim username untuk mengambil data terbaru
    ...
    private boolean isUsernameChanged() {
        if (!usernameUser.equals(editUsername.getText().toString())){
            reference.child(usernameUser).child("email").setValue(editUsername.getText().toString());
